...
def measure_runtime(
    ...
    test_instances = random.choices(test_instances, k=k)
    ...
    return total_runtime_seq, total_runtime_to_test


total_runtime_seq, total_runtime_to_test = measure_runtime(
    int(sys.argv[1]),
    additional_env_vars,
    list_len_database,
    list_nb_pattern,
